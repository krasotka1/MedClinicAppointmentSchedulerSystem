...
// author = doctor role
 ...
 $visits = unserialize($_POST['input_name']);
 $message = $_POST['txtArea'];
 foreach ($visits as $visit) {
    wp_mail( get_userdata($visit -> id) -> user_email, 'Appointment cancelled notification with MedClinic', $message ); 
 }
 ?>
 <div class='successApp'>Messages were sent  successfully! </div>

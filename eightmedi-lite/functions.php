...
function eightmedi_lite_scripts() {
	...
	//wp_enqueue_script( 'doctor-search', get_template_directory_uri() . '/js/docsearch.js',array(), '0', true);
...
function bswp_change_role_name() {
    ...
    $wp_roles->roles['subscriber']['name'] = 'Patient';
    $wp_roles->role_names['subscriber'] = 'Patient';  
    $wp_roles->roles['author']['name'] = 'Doctor';
    $wp_roles->role_names['author'] = 'Doctor';  
}

...
<form action="choose-a-time-slot/appointment-added" method="post" name="form3" id="specanddoc">

<div id="appMake">
<h2> Please select date of a visit </h2><br><br>
<label> Appointment for: </label>
<select name="personChosen" id="pers" form="specanddoc" onchange="if (this.selectedIndex == 0) {document.getElementById('persName').style.display = 'none'; document.getElementById('persName').required = false;}else {document.getElementById('persName').style.display = 'inline';document.getElementById('persName').required = true;}">
  <option value="0">Yourself</option>
  <option value="1">Another person</option>
</select><br>
<input placeholder="Person's full name" type='text' id='persName' name='persName' style="display:none;" /><br>
<label> Select date: </label><br>
<input placeholder="maximum 2 months" name="dateSelec" type='text' id='txtDate' name='txtDate' />
...
jQuery(document).ready(function($) {
    ...
    function getSchedule(dateS){
        ...
        wd[1][0] = new Array(2);
        aux = hours[0].split('-');
        wd[1][0].fromTime = aux[0];
        wd[1][0].toTime = aux[1];
        wd[2] = new Array();
        wd[2][0] = new Array(2);
        aux = hours[1].split('-');
        wd[2][0].fromTime = aux[0];
        wd[2][0].toTime = aux[1];
        wd[3] = new Array();
        wd[3][0] = new Array(2);
        aux = hours[2].split('-');
        wd[3][0].fromTime = aux[0];
        wd[3][0].toTime = aux[1];
        wd[4] = new Array();
        wd[4][0] = new Array(2);
        aux = hours[3].split('-');
        wd[4][0].fromTime = aux[0];
        wd[4][0].toTime = aux[1];
        wd[5] = new Array();
        wd[5][0] = new Array(2);
        aux = hours[4].split('-');
        wd[5][0].fromTime = aux[0];
        wd[5][0].toTime = aux[1];
        wd[6] = new Array();
        wd[6][0] = new Array(2);
        wd[6][0].fromTime = '0';
